...
//Cards implemented in functions instead

//smithy gets +3 cards - action card
void smithyCard(int currentPlayer, struct gameState *state, int handPos){
    int i;
    //BUG HERE: ORIGINAL: i = 0
    for(i = 1; i < 3; i++){
...
void adventureCard(int drawntreasure, struct gameState *state, int currentPlayer, int temphand[], int z){
  int cardDrawn;
...
void feastCard(struct gameState *state, int currentPlayer, int temphand[], int choice1){
  ...
  while( x == 1) {//Buy one card
      ...
      //BUG HERE: ORIGINAL: else if (state->coins < getCost(choice1)) -> changed the < to >
...
void villageCard(int currentPlayer, struct gameState *state, int handPos){
  ...
  //+2 Actions
  //BUG HERE: ORIGINAL: state->numActions = state->numActions + 2;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  int drawntreasure=0;
  // int cardDrawn; //put into function
  ...
  switch( card ) 
    {
    case adventurer:
      adventureCard(drawntreasure, state, currentPlayer, temphand, z);
      return 0;
